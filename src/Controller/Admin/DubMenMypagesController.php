 ...
 */
class DubMenMypagesController extends BcAdminAppController
{
    /**
     * Index method
     *
     ...
     */
    public function index(\DubMenbers\Service\Admin\DubMenMypagesAdminServiceInterface $service)
    {
     ...
     * View method
     *
     * @param \DubMenbers\Service\Admin\DubMenMypagesAdminServiceInterface $service
     * @param string|null $id Dub Men Mypage id.
     * @return \Cake\Http\Response|null|void Renders view
     * @throws \Cake\Datasource\Exception\RecordNotFoundException When record not found.
     */
    public function view(\DubMenbers\Service\Admin\DubMenMypagesAdminServiceInterface $service, int $id = null)
    {
     ...
     */
    public function add(\DubMenbers\Service\Admin\DubMenMypagesAdminServiceInterface $service)
    {
     ...
     * @throws \Cake\Datasource\Exception\RecordNotFoundException When record not found.
     */
    public function edit(\DubMenbers\Service\Admin\DubMenMypagesAdminServiceInterface $service, $id = null)
    {
     ...
     * @throws \Cake\Datasource\Exception\RecordNotFoundException When record not found.
     */
    public function delete(\DubMenbers\Service\Admin\DubMenMypagesAdminServiceInterface $service, $id = null)
    {
